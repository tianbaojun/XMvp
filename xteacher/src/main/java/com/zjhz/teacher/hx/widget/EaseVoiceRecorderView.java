package com.zjhz.teacher.hx.widget;
...
import com.zjhz.teacher.hx.model.EaseVoiceRecorder;
import com.zjhz.teacher.hx.utils.EaseCommonUtils;
import com.zjhz.teacher.hx.widget.chatrow.EaseChatRowVoicePlayClickListener;
...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    public void startRecording() {
        if (!EaseCommonUtils.isSdcardExist()) {
            ToastUtils.showShort(R.string.Send_voice_need_sdcard_support);
            return;
        }
        try {
            wakeLock.acquire();
