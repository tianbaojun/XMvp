package com.zjhz.teacher.hx.widget.chatrow;
...
import com.zjhz.teacher.hx.adapter.EaseMessageAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        ...
        userAvatarView = (ImageView) findViewById(R.id.iv_userhead);  // TODO 右边头像
    ...
    private void setUpBaseView(String head,String name) {
        ...
        //set nickname and avatar    TODO 昵称头像
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar("1",context, EMClient.getInstance().getCurrentUser(), userAvatarView);
        }else{
            EaseUserUtils.setUserAvatar("-1",context, message.getFrom(), userAvatarView);
