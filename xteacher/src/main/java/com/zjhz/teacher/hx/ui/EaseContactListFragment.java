...
import com.zjhz.teacher.hx.widget.EaseContactList;
...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        //to avoid crash when open app after long bespeakTime stay in background after user logged into another device
