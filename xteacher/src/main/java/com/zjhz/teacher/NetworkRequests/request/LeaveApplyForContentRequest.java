 ...
 */
public class LeaveApplyForContentRequest implements Serializable {
     ...
     */
    public LeaveApplyForContentRequest(String schoolId,String applyer, String applyerTime, String startTime, String sma, String endTime, String ema, String type, String summary,String week,String clazz,String subjectId,String teacherId) {
    ...
    public LeaveApplyForContentRequest(String schoolId,String applyer, String applyerTime, String startTime, String sma, String endTime, String ema, String type, String summary,String week,String clazz,String subjectId,String teacherId,String linkIds) {
        this.schoolId = schoolId;
        this.applyer = applyer;
        this.applyerTime = applyerTime;
        this.startTime = startTime;
