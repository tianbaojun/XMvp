package com.zjhz.teacher.ui.view.selectmorepicutil;
...
public class LocalImageHelper {
    ...
    public void setCheckedItems(List<LocalFile> checkedItems) {
...
//            if(bitmap == null){
//                try {
//                    bitmap = Bimp.revitionImageSize(imgPath);
//                } catch (IOException e) {
