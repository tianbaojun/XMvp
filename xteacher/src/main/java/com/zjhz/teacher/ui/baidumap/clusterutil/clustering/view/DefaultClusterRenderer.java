...
package com.zjhz.teacher.ui.baidumap.clusterutil.clustering.view;
...
import com.zjhz.teacher.ui.baidumap.clusterutil.MarkerManager;
import com.zjhz.teacher.ui.baidumap.clusterutil.clustering.Cluster;
import com.zjhz.teacher.ui.baidumap.clusterutil.clustering.ClusterItem;
import com.zjhz.teacher.ui.baidumap.clusterutil.clustering.ClusterManager;
import com.zjhz.teacher.ui.baidumap.clusterutil.projection.Point;
import com.zjhz.teacher.ui.baidumap.clusterutil.projection.SphericalMercatorProjection;
import com.zjhz.teacher.ui.baidumap.clusterutil.ui.IconGenerator;
import com.zjhz.teacher.ui.baidumap.clusterutil.ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /**
     * ViewModifier ensures only one re-rendering of the view occurs at a bespeakTime, and schedules
    ...
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        /**
         * Creates markers for a cluster some bespeakTime in the future.
         *
        ...
        /**
         * Removes a markerWithPosition some bespeakTime in the future.
         *
         * @param priority whether this operation should have priority.
        ...
        /**
         * Animates a markerWithPosition some bespeakTime in the future.
         *
        ...
        /**
         * Animates a markerWithPosition some bespeakTime in the future, and removes it when the animation
         * is complete.
         *
         * @param marker the markerWithPosition to animate.
         * @param from   the position to animate from.
