 ...
 */
package com.zjhz.teacher.ui.view.images.activity;
...
import com.zjhz.teacher.ui.view.images.app.AppOperator;
import com.zjhz.teacher.ui.view.images.base.BaseActivity;
import com.zjhz.teacher.ui.view.images.view.ImagePreviewView;
import com.zjhz.teacher.ui.view.images.view.PreviewerViewPager;
import com.zjhz.teacher.utils.PicturesCompressor;
import com.zjhz.teacher.utils.StreamUtils;
            ...
            public void run() {
                try {
                    ...
                    String extDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)
                            .getAbsolutePath() + File.separator + "智鹏千校云";
