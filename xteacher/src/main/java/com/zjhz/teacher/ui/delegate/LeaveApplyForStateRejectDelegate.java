 ...
 * Date: 2016-07-04
 * Time: 15:57
 * Description: 请假申请状态(驳回)
 */
public class LeaveApplyForStateRejectDelegate {

    LeaveApplyForStateRejectActivity activity;
    ...
    public LeaveApplyForStateRejectDelegate(LeaveApplyForStateRejectActivity activity) {
    ...
    public void initList(int type) {
        ...
        for(int i = 0; i < lists.size(); i++) {
            ...
            for(int j = 0; j < lists.get(i).lists.size(); j++) {
                ...
                child.linkId = lists.get(i).lists.get(j).linkId;
