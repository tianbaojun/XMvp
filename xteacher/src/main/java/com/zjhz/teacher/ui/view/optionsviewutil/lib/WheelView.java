package com.zjhz.teacher.ui.view.optionsviewutil.lib;
...
import com.zjhz.teacher.ui.view.optionsviewutil.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    // 条目间距倍数
    static final float lineSpacingMultiplier = 2.2F;
    //中间文字的大小
    static final float centerTextScaleX = 1.3F;
    boolean isLoop;
	...
	private void initPaints() {
        ...
        paintCenterText.setTextScaleX(centerTextScaleX);
