 ...
 */
public class ReceiveMeetingNoticeListActivity extends BaseActivity implements RefreshLayout.OnLoadListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView() {
        ...
        refreshListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                isDelete = false;
                index = position;
                Intent intent = new Intent(ReceiveMeetingNoticeListActivity.this,MessageDetailActivity.class);
...
//                    hintPopwindow = new HintPopwindow(ReceiveMeetingNoticeListActivity.this);
...
//                        isDelete = true;
//                        isUnread = datas.get(position).getIsTake();
//                        index = position;
//                        dialog.setMessage("正在删除...");
//                        dialog.show();
//                        NetworkRequest.request(new DeleteReceiveMessageParams(datas.get(position).getLinkId()),"OaMeetingService.removeMeetLink","deleteMeet");
...
//        });
    ...
    private void getData() {
        NetworkRequest.request(new ReceviceMessageParams(page,pageSize, SharedPreferencesUtils.getSharePrefString(ConstantKey.PhoneNoKey),"4"), CommonUrl.schoollist,"meetLinkList");
    }
    @Subscribe
