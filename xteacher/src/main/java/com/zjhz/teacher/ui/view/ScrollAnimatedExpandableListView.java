 ...
 * Description: 复式列表
 */
public class ScrollAnimatedExpandableListView extends ExpandableListView {
    @SuppressWarnings("unused")
	private static final String TAG = AnimatedExpandableListAdapter.class.getSimpleName();

    private static final int ANIMATION_DURATION = 0; // t

    private AnimatedExpandableListAdapter adapter;

    public ScrollAnimatedExpandableListView(Context context) {
        super(context);
    }

    public ScrollAnimatedExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScrollAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private ScrollAnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(ScrollAnimatedExpandableListView parent) {
            this.parent = parent;
        }
