...
import com.zjhz.teacher.ui.dialog.SelectPicPopwindow;
import com.zjhz.teacher.ui.view.OptionsPickerView;
import com.zjhz.teacher.ui.view.SpinerPopWindow;
...
public class EditFoodActivity extends BaseActivity implements LoadFile.FileCallBack {
    ...
    @OnClick({ R.id.title_back_img,R.id.right_text, R.id.type_ll})
