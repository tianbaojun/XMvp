 ...
 */
public class WorkPreviewOneAdapter extends BaseAdapter {

    private List<WorkPreviewBean> lists;
    private Context context;
    private OnDeleteClickListener mOnDeleteClickListener;

    public WorkPreviewOneAdapter(List<WorkPreviewBean> lists, Context context, OnDeleteClickListener onDeleteClickListener) {
        this.lists = lists;
