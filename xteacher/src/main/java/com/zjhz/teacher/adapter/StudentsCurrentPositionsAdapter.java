 ...
 */
public class StudentsCurrentPositionsAdapter extends BaseAdapter {

    private Context mContext;
    private List<StudentsCurrentPosition> lists;

    public StudentsCurrentPositionsAdapter(Context mContext, List<StudentsCurrentPosition> lists) {
