...
//        String versionName = packageInfo.versionName;
    ...
    public static String getIMEI() {
        String imei = ((TelephonyManager) AppContext.getInstance().getApplication().getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
        return imei;
    }
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return AppContext.getInstance().getApplication().getResources().getDisplayMetrics();
    }
    ...
    public static boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager) AppContext.getInstance().getApplication()
    ...
    public static boolean isPortrait() {
        return AppContext.getInstance().getApplication().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = AppContext.getInstance().getApplication().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(AppContext.getInstance().getApplication().getPackageName());
    }
    ...
    public static boolean isWifiOpen() {
        ConnectivityManager cm = (ConnectivityManager) AppContext
                .getInstance().getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo info = cm.getActiveNetworkInfo();
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) AppContext.getInstance().getApplication()
