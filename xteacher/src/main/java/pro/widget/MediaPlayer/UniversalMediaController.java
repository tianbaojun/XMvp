package pro.widget.MediaPlayer;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private void initControllerView(View v) {
        ...
        pic_video = (ImageView) v.findViewById(R.id.pic_video);
        if (mTurnButton != null) {
    ...
    private void showCenterView(int resId) {
        if (resId == R.id.loading_layout) {
            ...
            if (pic_video.getVisibility() != VISIBLE) {
                pic_video.setVisibility(VISIBLE);
            }
            if (loadingLayout.getVisibility() == VISIBLE) {
