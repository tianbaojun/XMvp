package pro.widget.TagContainerLayout;
...
import static com.zjhz.teacher.utils.SharePreCache.dp2px;
import static com.zjhz.teacher.utils.ToolsUtil.sp2px;
...
public class TagContainerLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr){
        ...
        mRectF = new RectF();
        mChildViews = new ArrayList<TagView>();
...
//    }
     ...
     * @param tags
     */
    public void setTitles(List<String> tags){
        mTags = tags;
        onSetTag();
    }
    ...
    public  List<TagView>  getAllChildViews(){
        return mChildViews;
    }
    ...
    static public  class  ViewColor {
        ...
        public ViewColor(int backgroundColor, int borderColor,int textColor){
