...
import static com.zjhz.teacher.utils.BaseUtil.dp2px;
...
public class TagView extends View {
    ...
    public void setTagViewColor(TagContainerLayout.ViewColor viewColor){
        this.setTagBackgroundColor(viewColor.getBackgroundColor());
        this.setTagBorderColor(viewColor.getBorderColor());
        this.setTagTextColor(viewColor.getTextColor());
        postInvalidate();
    }
