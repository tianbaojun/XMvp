...
//			mContainer = (LinearLayout) getChildAt(0);
	...
	public void notifyCurrentImgChanged()
	{
		...
		mListener.onCurrentImgChanged((mFristIndex+mCurrentIndex)/2, mContainer.getChildAt((0+mContainer.getChildCount())/2-1));
	...
	public void initDatas(HorizontalScrollViewAdapter mAdapter)
	{
		...
		params.width = metric.widthPixels/3;
...
//			Log.e(TAG, getScrollX() + "");
	...
	public Map<View, Integer> getmViewPos() {
		return mViewPos;
	}
}
