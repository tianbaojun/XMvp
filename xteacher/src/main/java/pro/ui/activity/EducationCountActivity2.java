...
import static com.zjhz.teacher.R.id.edu_submit;
...
public class EducationCountActivity2 extends BaseActivity {
    @Override
    ...
    //日期选择
    @BindView(R.id.edu_choose_date)
    TextView edu_choose_date;
    //班级总分
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edu_count_second);
    ...
    @OnClick({R.id.edu_choose_class, R.id.edu_choose_week, R.id.edu_choose_month, R.id.edu_choose_date, edu_submit, R.id.title_back_img})
    public void clickEvent(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.edu_choose_month://选择月
                selectMonth();
                break;
            case R.id.edu_choose_date://选择日期
                selectDate();
                break;
            case edu_submit: //提交
                submit();
        ...
        if (weekOfTerms != null && weekOfTerms.size() > 0) {
            ...
            optionsPickerView.setOnoptionsSelectListener(new OptionsPickerView.OnOptionsSelectListener() {
                ...
                public void onOptionsSelect(int options1, int options2, int options3, int options4) {
                    ...
                    edu_choose_date.setText(R.string.education_choose_date);
    ...
    private void selectDate() {
        ...
        pvTime.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, String type) {
                edu_choose_date.setText(TimeUtil.getYMD(date));
                edu_choose_week.setText(R.string.education_choose_weeks);
                edu_choose_month.setText(R.string.education_choose_month);
